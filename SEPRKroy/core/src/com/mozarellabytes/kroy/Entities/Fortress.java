...
public class Fortress {
    ...
    public void drawStats(ShapeRenderer shapeMapRenderer) {
        ...
        shapeMapRenderer.rect(this.getPosition().x - 0.13f, this.getPosition().y + 1.5f, 0.36f, this.getHP() / (this.fortressType.getMaxHP()*offset), Color.RED, Color.RED, Color.RED, Color.RED);
    }
