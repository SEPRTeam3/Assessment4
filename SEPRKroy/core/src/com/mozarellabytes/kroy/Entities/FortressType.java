...
public enum FortressType {
    ...
    Walmgate ("Walmgate Bar", 1500, 8, 120, 6, 5, 5, new Texture(Gdx.files.internal("sprites/fortress/fortress_walmgate.png"))),
    Clifford ("Clifford's Tower", 500, 4, 120, 8, 4, 3, new Texture(Gdx.files.internal("sprites/fortress/fortress_clifford.png"))),
    ...
    Minster ("Minster", 2000, 6, 110, 7, 5, 6, new Texture(Gdx.files.internal("sprites/fortress/minster.png"))),
